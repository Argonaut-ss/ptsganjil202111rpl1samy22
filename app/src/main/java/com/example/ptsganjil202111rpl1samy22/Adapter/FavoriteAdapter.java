...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.SportViewHolder> {
    ...
    public FavoriteAdapter(List<SportModel> sportModels, Context context) {
    ...
    @NonNull
    @Override
    public FavoriteAdapter.SportViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item, parent, false);
        return new FavoriteAdapter.SportViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoriteAdapter.SportViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            switch (item.getItemId()) {
                case R.id.option1:
                    ...
                    break;
                case R.id.option2:
                    Log.d("data hapus ", "onMenuItemClick: "+posisi);
                    realmHelper.delete(sportModels.get(posisi).getId());
